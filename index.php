    ...
    private function receiveText($object)
    {
        ...
        //自动回复模式
            ...
            if (strstr($keyword, "文本")){
                ...
                include("weather.php");
                $content = getWeatherInfo($keyword1);
                //$content = $keyword1;
            }else if (strstr($keyword, "快递")){
                $keyword1 = substr($keyword,6);
                include("express.php");
                $content = getExpressInfo($keyword1);
                //$content = $keyword1;
            }else if (strstr($keyword, "翻译")){
                $keyword1 = substr($keyword,6);
                include("translate.php");
                $content = getTranslateInfo($keyword1);
                //$content = $keyword1;
                ...
                include("joke.php");
                $keyword1 = substr($keyword,6);
                $content = getBondInfo($keyword1);
            }*/
            else if (strstr($keyword, "运势")){
                include("xingzuo.php");
                $keyword1 = substr($keyword,6);
                $content = getAstrologyInfo($keyword1);
            }
                ...
                $content = getRegisterInfo($keyword1,$openid);
                //$content = $keyword1;
            }
            else if (strstr($keyword, "个人信息查看")){
                //$keyword1 = substr($keyword,6);
                $openid = $object->FromUserName;
                include("viewinfo.php");
                $content = getViewInfo($openid);
                //$content = $keyword1;
            }
            else if (strstr($keyword, "警务信息查询")){
                //$openid = $object->FromUserName;
                include("policeinfo.php");
                $content = getPoliceInfo($keyword);
                //$content = $keyword1;
            }
                ...
                $openid = $object->FromUserName;
                include("signin.php");
                $content = getSignInfo($openid);
                //$content = $keyword1;
            }
            else if (strstr($keyword, "留言")){
                //$keyword1 = substr($keyword,6);
                $openid = $object->FromUserName;
                include("comment.php");
                $content = getCommentInfo($openid);
                //$content = $keyword1;
            }
            else{
